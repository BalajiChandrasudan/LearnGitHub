...
public class CreateLead extends SeMethods{
	...
	//classroomtestngS2 @Test(invocationCount=2,successPercentage=90)
	
	//homeworktestng2 @Test(invocationCount=2)
	
	//homeworktestng3 @Test(invocationCount=2, invocationTimeOut = 120000)
